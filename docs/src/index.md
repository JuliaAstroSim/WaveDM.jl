...
- [**Quickstart**](quickstart.md) — for first-time users; choose a model, run Crater II in under 10 minutes
- [Introduction](introduction.md) — wave dark matter background, design philosophy, ecosystem, model decision tree
